// XHook - v1.1.9 - https://github.com/jpillora/xhook
// Jaime Pillora <dev@jpillora.com> - MIT Copyright 2014

(function (window, undefined) {
    var AFTER, BEFORE, COMMON_EVENTS, EventEmitter, FIRE, FormData, OFF, ON, READY_STATE, UPLOAD_EVENTS, XHookHttpRequest, XMLHTTP, convertHeaders, document, fakeEvent, mergeObjects, proxyEvents, slice, xhook, _base;
    ...
    XHookHttpRequest = window[XMLHTTP] = function () {
        ...
        facade.send = function (body) {
            ...
            send = function () {
                ...
                transiting = true;
                // Kapsel modification: use request.async instead of hard-coding to true
                // to allow synchronous requests.
